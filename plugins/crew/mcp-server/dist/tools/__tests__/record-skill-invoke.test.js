...
import { SkillInvokeEventSchema, TelemetryEventSchema, } from "../../schemas/telemetry-events.js";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
...
async function readTelemetryEvents(targetRepoRoot) {
...
describe("recordSkillInvoke — AC4 capture seam (/crew:board, fallback prose-call path)", () => {
    ...
    it("the shipped /crew:board SKILL.md declares the seam tools and a skill_version", async () => {
        ...
        const skillPath = path.resolve(__dirname, "../../../../skills/board/SKILL.md");
