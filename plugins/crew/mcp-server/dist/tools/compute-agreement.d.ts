 ...
 */
import { type AgreementMetric } from "../lib/compute-agreement.js";
export interface ComputeAgreementInput {
    targetRepoRoot: string;
    lastNVerdicts?: number;
}
export declare function computeAgreement(input: ComputeAgreementInput): Promise<AgreementMetric | null>;
