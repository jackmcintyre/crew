 ...
 */
export function sanitiseRefForPathSegment(ref) {
 ...
 */
export function reviewerResultFilePath(targetRepoRoot, sessionUlid, ref) {
    return path.join(targetRepoRoot, ".crew", "state", "sessions", sessionUlid, sanitiseRefForPathSegment(ref), "reviewer-result.json");
}
/**
 ...
 */
export async function readReviewerResultFile(targetRepoRoot, sessionUlid, ref) {
