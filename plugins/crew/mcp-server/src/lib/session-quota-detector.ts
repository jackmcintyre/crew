...
const SESSION_QUOTA_RE =
  /you'?ve hit your (session|account) limit|you have hit your (session|account) limit|(session|account) limit reached/i;

export function detectSessionQuotaExhausted(transcript: string): boolean {
